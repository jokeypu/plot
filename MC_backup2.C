int MC_backup2()
{
    ...
    TH1D* h1 = new TH1D("h1", "hit", 100, 0.0, 1.2);
    TH1D* h2 = new TH1D("h2", "hit2", 100, 0.0, 1.2);
    ...
    for (Int_t ievt = 0; ievt < maxEvtNo; ievt++) {
        ...
        cout << "Number of Clusters: " << cc << endl;*/
       // h1->Fill(E);
        
        double EEE=0;
        for(Int_t j=0;j<fDigiArray->GetEntriesFast();j++){
            PndEmcDigi* digi=(PndEmcDigi*)fDigiArray->At(j);
            h2->Fill(digi->GetEnergy());
        }
    ...
    */
    ...
    leg->AddEntry(h1, "MCTruth Hit", "L");
    leg->AddEntry(h2, "Digi", "L");
    leg->SetTextFont(42);
    leg->Draw("SAME");
