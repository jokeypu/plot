...
int test()
{
    ...
    TH2D* h1D = new TH2D("h1D","h1",2000,-1,1,2000,-1,1);
    ...
    h1D->SetMarkerColorAlpha(kAzure+3, 1);
    ...
    for (Int_t ievt = 0; ievt < maxEvtNo; ievt++) {
        ...
        for (int i = 0; i < npoints; i++) {
            ...
            h1D->Fill(58*(pos.Theta()-1.270599695),58*(pos.Phi()-0.0087266),E);
        }
    N++;
    }
    ...
    /*for (int i = 0; i < 100 ; i++){
        ...
        for (int j = 0; j <100; j ++){
            ...
            cout << x << "   ";
            cout << y << "   ";
            cout << myfunc(sqrt(y*y+x*x),21.47,-0.2222,-0.1224,4.439) << endl;
        }
    }*/
    return 0;
}
