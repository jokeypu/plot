int ReadHit_v7()
{
    ...
    TH1D* hist = new TH1D("h","hist",100,0,3);
    ...
    */
    ...
    TF1 *f=new TF1("f","exp([1]*exp(-[2]*x)-[0])",1.0,6);
    f->SetLineWidth(2);
    f->SetLineColor(kRed);
    f->SetParameters(7,20,1);
    f->SetParLimits(0, 7, 10);
    f->SetParLimits(1, 10, 100);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
    f->SetParLimits(2, 0.1, 5);

/*    TF1 *f=new TF1("f","exp(-pow([0]*log(x-[1]),[2]))",1.24,3);
    f->SetLineWidth(2);
    f->SetLineColor(kRed);
    f->SetParameters(6.0,0.2,0.8);
    f->SetParLimits(0, 5.8, 6.8);
    f->SetParLimits(1, 0.0, 1);
    f->SetParLimits(2, 0.5, 1.24);
  */ 
/*  TF1 *f=new TF1("f","[1]*exp(-1*[0]*x)",0,8);
  f->SetLineWidth(2);
      f->SetLineColor(kRed);
