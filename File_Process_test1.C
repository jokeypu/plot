...
#include <string>
using namespace std;
int File_Process_test1(){
    std::string in_name = "doc/test_test.txt";
    std::string out_name = "doc/test_test_R.txt";
    ...
    float distance_max(4), angle_max(90);
    const int bin_x(16), bin_y(20);
    ...
    TGraph2D *g2 = new TGraph2D("doc/test_test_R.txt","%lg %lg %lg");
    g2->SetMarkerStyle(7);
