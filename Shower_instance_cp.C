...
int Shower_instance_cp(const char old_file[30], const char new_file[30], double Energy = 1.0 , int NO_Angle = 7)
{
    ...
    par_file << str_Energy << " " << Resolution_OR << " " << D_Resolution_OR_m << " " << D_Resolution_OR_p << " " << Resolution_fix << " " << D_Resolution_fix_m << " " << D_Resolution_fix_p << endl;
    
    cout << str_Energy << " " << Resolution_OR << " " << D_Resolution_OR_m << " " << D_Resolution_OR_p << " " << Resolution_fix << " " << D_Resolution_fix_m << " " << D_Resolution_fix_p << endl;
